    ...
    <wrapper-content :showHeader="false">
      ...
      >
        ...
        <a-list-item slot="renderItem" slot-scope="item,index">
          <span slot="actions" v-if="!item.system_template" @click="doAction(item,'stages')">
            <a-tooltip title="任务列表">
              <a-icon type="bars" />
            </a-tooltip>
          </span>
          <span slot="actions" v-if="!item.system_template" @click="doAction(item,'edit')">
            <a-tooltip title="编辑">
              <a-icon type="edit" />
            </a-tooltip>
          </span>
          <span slot="actions" v-if="!item.system_template" @click="doAction(item,'del',index)">
            <a-tooltip title="删除">
              <a-icon type="delete" />
            </a-tooltip>
          </span>
          <a-list-item-meta :description="item.description">
            <span slot="title">{{item.template_name}}</span>
          ...
          <div class="other-info muted">
            <div class="info-item task" v-if="item.task_stages.length">
              <a-breadcrumb separator=">">
                <a-breadcrumb-item
                  v-for="task in item.task_stages"
                  :key="task.task_name"
                >{{task.task_name}}</a-breadcrumb-item>
              </a-breadcrumb>
            </div>
          </div>
        </a-list-item>
