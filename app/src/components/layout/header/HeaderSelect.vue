<template>
  <div v-if="currentOrganization">
    <a-dropdown class="action-item" placement="bottomCenter">
      ...
      <a-menu
        slot="overlay"
        class="middle-menu organization-menu"
        :selectable="false"
        @click="organizationAction"
      >
...
//         app.organizationList[action.key]
//       );
//       changeCurrentOrganization(app.organizationList[action.key].code).then(
//         res => {
